                    ...
                    <Content>
                        {
                            currentUser ?
                                <div className={cx('wrapperProfile')}>
                                    <div className={cx('wrapperProfile__Item')}>
                                        <div className={cx('wrapperProfile__Item__Avatar')}>
                                        ...
                                        <div className={cx('wrapperProfile__Item__title')}>
                                            <span>THÔNG TIN NGƯỜI DÙNG</span>
                                        </div>
                                    </div>
                                    <div className={cx('wrapperProfile__Item2')}>
                                        <div className={cx('wrapperProfile__Item__child')}>

                                            <div className={cx('wrapperProfile__Item__child__Item')}>
                                                <div className={cx('wrapperProfile__Item__child__Item__Image')}>
                                                    <FontAwesomeIcon icon={faSignature} />
                                                </div>
                                                <div className={cx('Infor__Name')}>
                                                    <span>Tên</span>
                                                </div>
                                                <div className={cx('Infor__NameUser')}>
                                                    <span>{
                                                        currentUser ?
                                            ...
                                            <div className={cx('wrapperProfile__Item__child__Item')}>
                                                ...
                                                <div className={cx('Infor__NameUser')}>
                                                    {/* <span>{currentUser ? currentUser.brandId : '' */}
                                                    {/* }</span> */}
                                                </div>
                                            </div>
                                        </div>
